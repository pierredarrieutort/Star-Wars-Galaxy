...
const VorpaYa = L.marker([-95.28, 147.38], { icon: planetIcon }).bindTooltip("Vorpa'ya", { permanent: true, direction: 'right', offset: [0, -6], className: 'leaflet-tooltip    ' }); zoom06.addLayer(VorpaYa);
...
const TelkurSta = L.marker([-108.178, 147.594], { icon: statonIcon }).bindTooltip("Telkur Sta.", { permanent: true, direction: 'left', offset: [0, -3], className: 'leaflet-tooltip    ' }); zoom07.addLayer(TelkurSta);
...
const Sargon = L.marker([-107.904, 147.694], { icon: planetIcon }).bindTooltip("Sargon", { permanent: true, direction: 'left', offset: [2, -8], className: 'leaflet-tooltip    ' }); zoom08.addLayer(Sargon);
...
const Talcharaim = L.marker([-108.036, 147.739], { icon: planetIcon }).bindTooltip("Talcharaim", { permanent: true, direction: 'left', offset: [0, 0], className: 'leaflet-tooltip    ' }); zoom10.addLayer(Talcharaim);
...
const Baldavia = L.marker([-107.991, 147.754], { icon: planetIcon }).bindTooltip("Baldavia", { permanent: true, direction: 'right', offset: [-4, -10], className: 'leaflet-tooltip   ' }); zoom11.addLayer(Baldavia);
...
const LalmyAsh = L.marker([-108.021, 147.765], { icon: planetIcon }).bindTooltip("Lalmy'ash", { permanent: true, direction: 'right', offset: [0, 0], className: 'leaflet-tooltip    ' }); zoom10.addLayer(LalmyAsh);
...
//Hapan Spine [mint polyline]
var hps001 = new L.LatLng(-104.42, 147.77); //Taanab
var hps002 = new L.LatLng(-104.75, 147.82); //near Taanab
var hps003 = new L.LatLng(-105.06, 147.84); //near Norulac
var hps004 = new L.LatLng(-105.26, 147.87); //Norulac
var hps005 = new L.LatLng(-106.64, 147.88); //near Blacktar Cyst
var hps006 = new L.LatLng(-107.04, 147.84); //near Blacktar Cyst 2
var hps007 = new L.LatLng(-107.25, 147.80); //near Blacktar Cyst 3
var hps008 = new L.LatLng(-107.65, 147.78); //near Orleon
var hps009 = new L.LatLng(-107.68, 147.79); //near Orleon 2
var hps010 = new L.LatLng(-107.70, 147.82); //near Orleon 3
var hps011 = new L.LatLng(-107.71, 147.86); //near Rainboh
var hps012 = new L.LatLng(-107.69, 147.94); //near Rainboh 2
var hps013 = new L.LatLng(-107.70, 147.97); //near Rainboh 3
var hps014 = new L.LatLng(-107.78, 148.03); //near Roqoo Depot
var hps015 = new L.LatLng(-107.80, 148.04); //near Roqoo Depot 2
var hps016 = new L.LatLng(-107.81, 148.03); //near Roqoo Depot 3
var hps017 = new L.LatLng(-107.83, 148.02); //near Roqoo Depot 4
var hps018 = new L.LatLng(-107.83, 148.01); //near Roqoo Depot 5
var hps019 = new L.LatLng(-107.87, 147.99); //near Roqoo Depot 6
var hps020 = new L.LatLng(-107.87, 147.99); //near Roqoo Depot 7
var hps021 = new L.LatLng(-107.875, 147.979); //Roqoo Depot
var hps022 = new L.LatLng(-107.884, 147.957); //near Roqoo Depot 8
var hps023 = new L.LatLng(-107.891, 147.952); //near Roqoo Depot 9
var hps024 = new L.LatLng(-107.890, 147.944); //near Roqoo Depot 10
var hps025 = new L.LatLng(-107.896, 147.939); //near Roqoo Depot 11
var hps026 = new L.LatLng(-107.896, 147.939); //unknown world 0.6.6 / 9.5.3 (1)
var hps027 = new L.LatLng(-107.905, 147.922); //unknown world 0.6.6 / 9.5.3 (2)
var hps028 = new L.LatLng(-107.907, 147.912); //unknown world 0.6.6 / 9.5.3 (3)
var hps029 = new L.LatLng(-107.906, 147.901); //unknown world 0.6.6 / 9.5.3 (4)
var hps030 = new L.LatLng(-107.902, 147.893); //near Terephon
var hps031 = new L.LatLng(-107.901, 147.888); //Terephon

var pointList = [hps001, hps002, hps003, hps004, hps005, hps006, hps007, hps008, hps009, hps010, hps011, hps012, hps013, hps014, hps015, hps016, hps017, hps018, hps019, hps020, hps021, hps022, hps023, hps024,
  hps025, hps026, hps027, hps028, hps029, hps030, hps031];
...
//Hapan Trail* [blue polyline]
var hpt001 = new L.LatLng(-107.910, 147.767); //Febrini
var hpt002 = new L.LatLng(-107.917, 147.772); //near Febrini
var hpt003 = new L.LatLng(-107.923, 147.775); //near Zadaria
var hpt004 = new L.LatLng(-107.929, 147.777); //Zadaria
var hpt005 = new L.LatLng(-107.936, 147.775); //near Phelope
var hpt006 = new L.LatLng(-107.943, 147.776); //Phelope
var hpt007 = new L.LatLng(-107.953, 147.779); //near Phelope 2
var hpt008 = new L.LatLng(-107.968, 147.789); //Ediorung
var hpt009 = new L.LatLng(-107.981, 147.798); //Carlania
var hpt010 = new L.LatLng(-107.985, 147.800); //near Carlania
var hpt011 = new L.LatLng(-107.992, 147.802); //near Arabanth
var hpt012 = new L.LatLng(-107.995, 147.804); //Arabanth
var hpt013 = new L.LatLng(-108.001, 147.808); //near Hapes
var hpt014 = new L.LatLng(-108.008, 147.811); //Hapes
var hpt015 = new L.LatLng(-108.021, 147.806); //Ut
var hpt016 = new L.LatLng(-108.032, 147.796); //Harterra
var hpt017 = new L.LatLng(-108.039, 147.786); //Selab
var hpt018 = new L.LatLng(-108.039, 147.776); //near Selab
var hpt019 = new L.LatLng(-108.031, 147.770); //Archais
var hpt020 = new L.LatLng(-108.021, 147.765); //Lalmy'ash
var hpt021 = new L.LatLng(-108.015, 147.764); //near Millinar
var hpt022 = new L.LatLng(-108.010, 147.762); //Millinar
var hpt023 = new L.LatLng(-107.993, 147.769); //Theselon
var hpt024 = new L.LatLng(-107.991, 147.754); //Baldavia
var hpt025 = new L.LatLng(-107.987, 147.747); //near Gallinore (corner)
var hpt026 = new L.LatLng(-107.990, 147.747); //near Gallinore 2
var hpt027 = new L.LatLng(-107.995, 147.743); //near Novi
var hpt028 = new L.LatLng(-107.994, 147.739); //Novi
var hpt029 = new L.LatLng(-108.001, 147.736); //near Farnica
var hpt030 = new L.LatLng(-108.008, 147.736); //Farnica
var hpt031 = new L.LatLng(-108.015, 147.737); //near Sivoria
var hpt032 = new L.LatLng(-108.021, 147.737); //Sivoria
var hpt033 = new L.LatLng(-108.026, 147.737); //near Sivoria 2
var hpt034 = new L.LatLng(-108.027, 147.738); //near Talcharaim
var hpt035 = new L.LatLng(-108.036, 147.739); //Talcharaim

var pointList = [hpt001, hpt002, hpt003, hpt004, hpt005, hpt006, hpt007, hpt008, hpt009, hpt010, hpt011, hpt012, hpt013, hpt014, hpt015, hpt016, hpt017, hpt018, hpt019, hpt020, hpt021, hpt022, hpt023, hpt024,
  hpt025, hpt026, hpt027, hpt028, hpt029, hpt030, hpt031, hpt032, hpt033, hpt034, hpt035];
var hapanTrail = new L.Polyline(pointList, {
  color: "#4363d8",
  weight: 3,
  opacity: .9,
  smoothFactor: 1
});
hapanTrail.addTo(map);

//Hapan Pass* [magenta polyline]
var hpp001 = new L.LatLng(-109.16, 149.82); //Porus Vida
var hpp002 = new L.LatLng(-108.94, 149.05); //near Porus Vida
var hpp003 = new L.LatLng(-108.70, 148.51); //near Porus Vida 2
var hpp004 = new L.LatLng(-108.52, 148.20); //near Porus Vida 3
var hpp005 = new L.LatLng(-108.41, 148.00); //near Calfa
var hpp006 = new L.LatLng(-108.40, 147.99); //near Calfa 2
var hpp007 = new L.LatLng(-108.38, 147.98); //near Calfa 3
var hpp008 = new L.LatLng(-108.365, 147.980); //Hapan Bypass
var hpp009 = new L.LatLng(-108.356, 147.948); //near Chosper 7
var hpp010 = new L.LatLng(-108.354, 147.899); //near Chosper 6
var hpp011 = new L.LatLng(-108.359, 147.781); //near Chosper 5
var hpp012 = new L.LatLng(-108.355, 147.755); //near Chosper 4
var hpp013 = new L.LatLng(-108.339, 147.717); //near Chosper 3
var hpp014 = new L.LatLng(-108.325, 147.676); //near Chosper 2
var hpp015 = new L.LatLng(-108.304, 147.627); //near Chosper
var hpp016 = new L.LatLng(-108.289, 147.575); //near Telkur Sta.
var hpp017 = new L.LatLng(-108.277, 147.521); //near Lorell 4
var hpp018 = new L.LatLng(-108.261, 147.503); //near Lorell 3
var hpp019 = new L.LatLng(-108.243, 147.497); //Lorell

var pointList = [hpp001, hpp002, hpp003, hpp004, hpp005, hpp006, hpp007, hpp008, hpp009, hpp010, hpp011, hpp012, hpp013, hpp014, hpp015, hpp016, hpp017, hpp018, hpp019];
var hapanPass = new L.Polyline(pointList, {
  color: "#DCA3D9",
  weight: 3,
  opacity: .9,
  lineCap: 'square',
  smoothFactor: 1
}); zoom05.addLayer(hapanPass);

//Hapan Bypass* [magenta polyline]
var hpb001 = new L.LatLng(-108.365, 147.980); //Hapan Route
var hpb002 = new L.LatLng(-108.33, 147.98); //near Calfa
var hpb003 = new L.LatLng(-108.29, 147.99); //near Calfa 2
var hpb004 = new L.LatLng(-108.28, 148.00); //near Calfa 3
var hpb005 = new L.LatLng(-108.25, 148.04); //near Calfa 4
var hpb006 = new L.LatLng(-108.21, 148.07); //near Calfa 5
var hpb007 = new L.LatLng(-108.18, 148.08); //near Calfa 6
var hpb008 = new L.LatLng(-108.14, 148.07); //near Dreena
var hpb009 = new L.LatLng(-108.12, 148.06); //near Dreena 2
var hpb010 = new L.LatLng(-108.09, 148.06); //near Reboam
var hpb011 = new L.LatLng(-107.92, 148.08); //near Shedu Maad
var hpb012 = new L.LatLng(-107.85, 148.07); //near Roqoo Depot
var hpb013 = new L.LatLng(-107.80, 148.04); //near Roqoo Depot 2

var pointList = [hpb001, hpb002, hpb003, hpb004, hpb005, hpb006, hpb007, hpb008, hpb009, hpb010, hpb011, hpb012, hpb013];
var hapanBypass = new L.Polyline(pointList, {
  color: "#ffd8b1",
  weight: 3,
  opacity: .9,
  smoothFactor: 1
}); zoom05.addLayer(hapanBypass);
...
var mnd027 = new L.LatLng(-93.87, 148.49); //near Mandalore
...
var vom014 = new L.LatLng(-93.92, 148.52); //Mandalore
