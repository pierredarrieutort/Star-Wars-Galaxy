export default {
  ...
  "features": [
    ...
    },
    {
      "type": "Feature",
      "properties": {
        "tooltipContent": "Look revealing label!"
      },
      "geometry": {
        "type": "Point",
        "coordinates": [
